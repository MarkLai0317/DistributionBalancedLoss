...
class SimpleClassifier(BaseClassifier):
    ...
    def __init__(self,
        ...
        # summary(self, input_size=(32,3,224,224), depth=4, col_names=("input_size", "output_size", "num_params"))
