...
(
python tools/train.py configs/voc/35_6_101/LT_resnet101_pfc_DB_uniform_bce_35_6_group1.py
) &
(
python tools/train.py configs/voc/35_6_101/LT_resnet101_pfc_DB_uniform_bce_35_6_group2.py
) &
(
python tools/train.py configs/voc/35_6_101/LT_resnet101_pfc_DB_uniform_bce_35_6_group3.py
) 
