...
model = dict(
    ...
    head=dict(
        ...
        loss_cls=dict(
            ...
            loss_weight=1.0, freq_file='appendix/mured/group3/class_freq_new.pkl')))
# model training and testing settings
train_cfg = dict()
test_cfg = dict()

# dataset settings
dataset_type = 'MuredDatasetGroup3'
data_root = 'appendix/mured/'
online_data_root = 'appendix/mured/group3/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file='appendix/mured/group3/mured_annotations_test.pkl',
        class_split='appendix/mured/group3/class_split.pkl',
        img_prefix='appendix/mured/images/',
        img_scale=(img_size, img_size),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32, 
...
log_level = 'INFO'
work_dir = './work_dirs/LT_mured_resnet50_pfc_DB_adam224_group3_original_sample'
load_from = None
if start_epoch > 0:
