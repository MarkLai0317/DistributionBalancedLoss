...
# dataset settings
dataset_type = 'MuredDatasetGroup1'
data_root = 'appendix/mured/group1/'
online_data_root = 'appendix/mured/group1/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/LT_mured_resnet50_pfc_DB_adam224_onecycle_bce_uniform_sample_group1'
load_from = None
if start_epoch > 0:
