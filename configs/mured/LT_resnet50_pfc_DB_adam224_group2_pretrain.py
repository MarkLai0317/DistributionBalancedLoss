...
model = dict(
    ...
    pretrained='work_dirs/LT_mured_resnet50_pfc_DB_adam224_onecycle2/epoch_62.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
log_level = 'INFO'
work_dir = './work_dirs/LT_mured_resnet50_pfc_DB_adam224_group2_DBloss_negscale3_pretrain'
load_from = None
if start_epoch > 0:
