...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file='appendix/mured/group2/mured_annotations_test.pkl',
        class_split='appendix/mured/group2/class_split.pkl',
        img_prefix='appendix/mured/images/',
        img_scale=(img_size, img_size),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32, 
...
log_level = 'INFO'
work_dir = './work_dirs/LT_mured_resnet50_pfc_DB_adam224_group2_classaware_original_bce_LRtime2'
load_from = None
if start_epoch > 0:
