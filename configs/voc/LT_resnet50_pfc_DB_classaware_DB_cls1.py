...
model = dict(
    ...
    head=dict(
        ...
        loss_cls=dict(
            ...
            loss_weight=1.0, freq_file='/home/mark/Desktop/工研院/multi-label_classification/data/voc/DB/class_freq.pkl')))
...
log_level = 'INFO'
work_dir = './work_dirs/LT_voc_resnet50_pfc_DB_new_cls1'
load_from = None
resume_from = None
workflow = [('train', 1)]
