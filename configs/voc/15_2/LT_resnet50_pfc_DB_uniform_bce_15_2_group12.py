...
online_data_root = "/home/mark/Desktop/工研院/multi-label_classification/data/voc/15_2_group12/"
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = "./work_dirs/LT_voc_resnet50_pfc_DB_uniform_bce_15_2_group12"
load_from = None
resume_from = None
workflow = [('train', 1)]
