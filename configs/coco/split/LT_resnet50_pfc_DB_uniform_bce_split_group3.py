...
online_data_root = '/home/mark/Desktop/工研院/multi-label_classification/data/coco/split_group3/'
...
log_level = 'INFO'
work_dir = './work_dirs/LT_coco_resnet50_pfc_DB_uniform_bce_split_group3'
load_from = None
if start_epoch > 0:
