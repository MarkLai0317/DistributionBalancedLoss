...
model = dict(
    ...
    head=dict(
        ...
        loss_cls=dict(
            ...
            loss_weight=1.0, freq_file='appendix/coco/longtail2017_group/class_freq_group2.pkl')))
# model training and testing settings
train_cfg = dict()
test_cfg = dict()

# dataset settings
dataset_type = 'CocoDatasetOriginalGroup2'
...
data = dict(
    ...
    train=dict(
            type=dataset_type,
            ann_file=data_root + 'annotations/instances_train2017_group2.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_val2017_group2.json',
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_val2017_group2.json',
        class_split=online_data_root + 'coco/longtail2017_group/class_split_group2.pkl',
        img_prefix=data_root + 'val2017/',
        img_scale=(img_size, img_size),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32, 
...
log_level = 'INFO'
work_dir = './work_dirs/LT_coco_resnet50_pfc_DB_group2_16'
load_from = None
if start_epoch > 0:
