...
model = dict(
    ...
    head=dict(
        ...
        loss_cls=dict(
          type='CBLoss', 
          freq_file='/home/mark/Desktop/工研院/multi-label_classification/data/coco/DB/class_freq.pkl',
          loss_type= 'focal',
          gamma=0.5,
          no_of_classes=80,
          )))
...
log_level = 'INFO'
work_dir = './work_dirs/LT_coco_resnet50_pfc_DB_uniform_cb_focal_balance5_gamma05_original'
load_from = None
if start_epoch > 0:
